...
class BaseUNet(nn.Module):
    def __init__(self, num_input_channels, num_output_channels=1, skip_type='sum', activation='sigmoid',
        ...
        self.num_input_channels = num_input_channels # 5 (number of bins)
        self.num_output_channels = num_output_channels # 1
        self.skip_type = skip_type # 'none'
        self.apply_skip_connection = skip_sum if self.skip_type == 'sum' else skip_concat # skip_concat
