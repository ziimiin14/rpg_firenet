    ...
    def update_reconstruction(self, event_tensor, event_tensor_id, stamp=None):
        with torch.no_grad():
            ...
            with CudaTimer('Reconstruction'):
                ...
                events_for_each_channel = {'grayscale': events}
                # print(events_for_each_channel['grayscale'].shape)
                # print(last_states_for_each_channel['grayscale'].shape)
                ...
                for channel in events_for_each_channel.keys():
                    ...
                    # print(channel)
                    # print(self.last_states_for_each_channel[channel][0].shape)
