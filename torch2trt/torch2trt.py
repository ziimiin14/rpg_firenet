...
def torch2trt(module, 
    ...
    output,state = module(curr_state,prev_state)
    outputs =[]
    ...
    if use_onnx:
        ...
        f = io.BytesIO()
        torch.onnx.export(module, (curr_state,prev_state), f, input_names=input_names, output_names=output_names)
        f.seek(0)
        onnx_bytes = f.read()
        ...
        with ConversionContext(network, torch2trt_kwargs=kwargs) as ctx:
            ...
            b,outputs = module(curr_state,prev_state)
            outputs.append(b)
